  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to Calendoodles! You can now log in.",
      });
      ...
      <div className="flex flex-1 items-center justify-center p-4 sm:p-6 relative z-10">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <h1 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">Create an account</h1>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Join Calendoodles to manage your appointments with ease
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 px-6 py-8 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 mt-6">
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  I agree to the{" "}
                  <Link to="/terms" className="text-calendoodle-blue hover:text-calendoodle-purple">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-calendoodle-blue hover:text-calendoodle-purple">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <div className="text-center">
                <span className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link to="/login" className="text-calendoodle-blue hover:text-calendoodle-purple font-medium">
                    Sign in
                  </Link>
                </span>
              </div>
